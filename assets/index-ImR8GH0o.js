...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function Xo(){return new It({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ha(),fragmentShader:`
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function Yo(){return new It({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ha(),fragmentShader:`
...
`)}function bm(i,e){let t;switch(e){case hh:t="Linear";break;case uh:t="Reinhard";break;case dh:t="Cineon";break;case fh:t="ACESFilmic";break;case mh:t="AgX";break;case _h:t="Neutral";break;case ph:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const yr=new L;function wm(){We.getLuminanceCoefficients(yr);const i=yr.x.toFixed(4),e=yr.y.toFixed(4),t=yr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Am(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Oi).join(`
`)}function Cm(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Rm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Oi(i){return i!==""}function il(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Pm=/^[ \t]*#include +<([\w\d./]+)>/gm;function ya(i){return i.replace(Pm,Lm)}const Dm=new Map;function Lm(i,e){let t=Ue[e];if(t===void 0){const n=Dm.get(e);if(n!==void 0)t=Ue[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ya(t)}const Um=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sl(i){return i.replace(Um,Im)}function Im(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function al(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Nm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ul?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Gc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===sn&&(e="SHADOWMAP_TYPE_VSM"),e}function Fm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Mi:case Si:e="ENVMAP_TYPE_CUBE";break;case Br:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Om(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Si:e="ENVMAP_MODE_REFRACTION";break}return e}function Bm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Il:e="ENVMAP_BLENDING_MULTIPLY";break;case lh:e="ENVMAP_BLENDING_MIX";break;case ch:e="ENVMAP_BLENDING_ADD";break}return e}function zm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function km(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Nm(t),c=Fm(t),u=Om(t),h=Bm(t),f=zm(t),p=Am(t),_=Cm(s),g=r.createProgram();let m,d,E=t.glslVersion?"#version "+t.glslVersion+`
...
}`;class h_{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new bt,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=n.depthNear||t.depthFar!=n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new It({vertexShader:l_,fragmentShader:c_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new _t(new Hr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class u_ extends qn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,h=null,f=null,p=null,_=null;const g=new h_,m=t.getContextAttributes();let d=null,E=null;const T=[],S=[],C=new Ae;let A=null;const R=new kt;R.viewport=new lt;const D=new kt;D.viewport=new lt;const y=[R,D],x=new Ru;let w=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let ee=T[j];return ee===void 0&&(ee=new Ss,T[j]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(j){let ee=T[j];return ee===void 0&&(ee=new Ss,T[j]=ee),ee.getGripSpace()},this.getHand=function(j){let ee=T[j];return ee===void 0&&(ee=new Ss,T[j]=ee),ee.getHandSpace()};function F(j){const ee=S.indexOf(j.inputSource);if(ee===-1)return;const me=T[ee];me!==void 0&&(me.update(j.inputSource,j.frame,c||a),me.dispatchEvent({type:j.type,data:j.inputSource}))}function W(){r.removeEventListener("select",F),r.removeEventListener("selectstart",F),r.removeEventListener("selectend",F),r.removeEventListener("squeeze",F),r.removeEventListener("squeezestart",F),r.removeEventListener("squeezeend",F),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",X);for(let j=0;j<T.length;j++){const ee=S[j];ee!==null&&(S[j]=null,T[j].disconnect(ee))}w=null,O=null,g.reset(),e.setRenderTarget(d),p=null,f=null,h=null,r=null,E=null,$e.stop(),n.isPresenting=!1,e.setPixelRatio(A),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){o=j,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(j){c=j},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(d=e.getRenderTarget(),r.addEventListener("select",F),r.addEventListener("selectstart",F),r.addEventListener("selectend",F),r.addEventListener("squeeze",F),r.addEventListener("squeezestart",F),r.addEventListener("squeezeend",F),r.addEventListener("end",W),r.addEventListener("inputsourceschange",X),m.xrCompatible!==!0&&await t.makeXRCompatible(),A=e.getPixelRatio(),e.getSize(C),r.renderState.layers===void 0){const ee={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,ee),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),E=new Xn(p.framebufferWidth,p.framebufferHeight,{format:jt,type:un,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let ee=null,me=null,se=null;m.depth&&(se=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=m.stencil?Ti:gi,me=m.stencil?Ei:Wn);const Te={colorFormat:t.RGBA8,depthFormat:se,scaleFactor:s};h=new XRWebGLBinding(r,t),f=h.createProjectionLayer(Te),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),E=new Xn(f.textureWidth,f.textureHeight,{format:jt,type:un,depthTexture:new nc(f.textureWidth,f.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),$e.setContext(r),$e.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function X(j){for(let ee=0;ee<j.removed.length;ee++){const me=j.removed[ee],se=S.indexOf(me);se>=0&&(S[se]=null,T[se].disconnect(me))}for(let ee=0;ee<j.added.length;ee++){const me=j.added[ee];let se=S.indexOf(me);if(se===-1){for(let Re=0;Re<T.length;Re++)if(Re>=S.length){S.push(me),se=Re;break}else if(S[Re]===null){S[Re]=me,se=Re;break}if(se===-1)break}const Te=T[se];Te&&Te.connect(me)}}const H=new L,Y=new L;function V(j,ee,me){H.setFromMatrixPosition(ee.matrixWorld),Y.setFromMatrixPosition(me.matrixWorld);const se=H.distanceTo(Y),Te=ee.projectionMatrix.elements,Re=me.projectionMatrix.elements,Fe=Te[14]/(Te[10]-1),nt=Te[14]/(Te[10]+1),ke=(Te[9]+1)/Te[5],ot=(Te[9]-1)/Te[5],P=(Te[8]-1)/Te[0],Ft=(Re[8]+1)/Re[0],Oe=Fe*P,Be=Fe*Ft,ve=se/(-P+Ft),et=ve*-P;if(ee.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(et),j.translateZ(ve),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert(),Te[10]===-1)j.projectionMatrix.copy(ee.projectionMatrix),j.projectionMatrixInverse.copy(ee.projectionMatrixInverse);else{const xe=Fe+ve,b=nt+ve,v=Oe-et,B=Be+(se-et),Z=ke*nt/b*xe,$=ot*nt/b*xe;j.projectionMatrix.makePerspective(v,B,Z,$,xe,b),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}}function te(j,ee){ee===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(ee.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;let ee=j.near,me=j.far;g.texture!==null&&(g.depthNear>0&&(ee=g.depthNear),g.depthFar>0&&(me=g.depthFar)),x.near=D.near=R.near=ee,x.far=D.far=R.far=me,(w!==x.near||O!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),w=x.near,O=x.far),R.layers.mask=j.layers.mask|2,D.layers.mask=j.layers.mask|4,x.layers.mask=R.layers.mask|D.layers.mask;const se=j.parent,Te=x.cameras;te(x,se);for(let Re=0;Re<Te.length;Re++)te(Te[Re],se);Te.length===2?V(x,R,D):x.projectionMatrix.copy(R.projectionMatrix),ce(j,x,se)};function ce(j,ee,me){me===null?j.matrix.copy(ee.matrixWorld):(j.matrix.copy(me.matrixWorld),j.matrix.invert(),j.matrix.multiply(ee.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(ee.projectionMatrix),j.projectionMatrixInverse.copy(ee.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=Gi*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(j){l=j,f!==null&&(f.fixedFoveation=j),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=j)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(x)};let ge=null;function Ne(j,ee){if(u=ee.getViewerPose(c||a),_=ee,u!==null){const me=u.views;p!==null&&(e.setRenderTargetFramebuffer(E,p.framebuffer),e.setRenderTarget(E));let se=!1;me.length!==x.cameras.length&&(x.cameras.length=0,se=!0);for(let Re=0;Re<me.length;Re++){const Fe=me[Re];let nt=null;if(p!==null)nt=p.getViewport(Fe);else{const ot=h.getViewSubImage(f,Fe);nt=ot.viewport,Re===0&&(e.setRenderTargetTextures(E,ot.colorTexture,f.ignoreDepthValues?void 0:ot.depthStencilTexture),e.setRenderTarget(E))}let ke=y[Re];ke===void 0&&(ke=new kt,ke.layers.enable(Re),ke.viewport=new lt,y[Re]=ke),ke.matrix.fromArray(Fe.transform.matrix),ke.matrix.decompose(ke.position,ke.quaternion,ke.scale),ke.projectionMatrix.fromArray(Fe.projectionMatrix),ke.projectionMatrixInverse.copy(ke.projectionMatrix).invert(),ke.viewport.set(nt.x,nt.y,nt.width,nt.height),Re===0&&(x.matrix.copy(ke.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),se===!0&&x.cameras.push(ke)}const Te=r.enabledFeatures;if(Te&&Te.includes("depth-sensing")){const Re=h.getDepthInformation(me[0]);Re&&Re.isValid&&Re.texture&&g.init(e,Re,r.renderState)}}for(let me=0;me<T.length;me++){const se=S[me],Te=T[me];se!==null&&Te!==void 0&&Te.update(se,ee,c||a)}ge&&ge(j,ee),ee.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ee}),_=null}const $e=new ic;$e.setAnimationLoop(Ne),this.setAnimationLoop=function(j){ge=j},this.dispose=function(){}}}const Un=new dn,d_=new at;function f_(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Jl(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,E,T,S){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,S)):d.isMeshMatcapMaterial?(s(m,d),_(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),g(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?l(m,d,E,T):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Pt&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Pt&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const E=e.get(d),T=E.envMap,S=E.envMapRotation;T&&(m.envMap.value=T,Un.copy(S),Un.x*=-1,Un.y*=-1,Un.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(Un.y*=-1,Un.z*=-1),m.envMapRotation.value.setFromMatrix4(d_.makeRotationFromEuler(Un)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,E,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*E,m.scale.value=T*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,E){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Pt&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function g(m,d){const E=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function p_(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(E,T){const S=T.program;n.uniformBlockBinding(E,S)}function c(E,T){let S=r[E.id];S===void 0&&(_(E),S=u(E),r[E.id]=S,E.addEventListener("dispose",m));const C=T.program;n.updateUBOMapping(E,C);const A=e.render.frame;s[E.id]!==A&&(f(E),s[E.id]=A)}function u(E){const T=h();E.__bindingPointIndex=T;const S=i.createBuffer(),C=E.__size,A=E.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,C,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,S),S}function h(){for(let E=0;E<o;E++)if(a.indexOf(E)===-1)return a.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(E){const T=r[E.id],S=E.uniforms,C=E.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let A=0,R=S.length;A<R;A++){const D=Array.isArray(S[A])?S[A]:[S[A]];for(let y=0,x=D.length;y<x;y++){const w=D[y];if(p(w,A,y,C)===!0){const O=w.__offset,F=Array.isArray(w.value)?w.value:[w.value];let W=0;for(let X=0;X<F.length;X++){const H=F[X],Y=g(H);typeof H=="number"||typeof H=="boolean"?(w.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,O+W,w.__data)):H.isMatrix3?(w.__data[0]=H.elements[0],w.__data[1]=H.elements[1],w.__data[2]=H.elements[2],w.__data[3]=0,w.__data[4]=H.elements[3],w.__data[5]=H.elements[4],w.__data[6]=H.elements[5],w.__data[7]=0,w.__data[8]=H.elements[6],w.__data[9]=H.elements[7],w.__data[10]=H.elements[8],w.__data[11]=0):(H.toArray(w.__data,W),W+=Y.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,O,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(E,T,S,C){const A=E.value,R=T+"_"+S;if(C[R]===void 0)return typeof A=="number"||typeof A=="boolean"?C[R]=A:C[R]=A.clone(),!0;{const D=C[R];if(typeof A=="number"||typeof A=="boolean"){if(D!==A)return C[R]=A,!0}else if(D.equals(A)===!1)return D.copy(A),!0}return!1}function _(E){const T=E.uniforms;let S=0;const C=16;for(let R=0,D=T.length;R<D;R++){const y=Array.isArray(T[R])?T[R]:[T[R]];for(let x=0,w=y.length;x<w;x++){const O=y[x],F=Array.isArray(O.value)?O.value:[O.value];for(let W=0,X=F.length;W<X;W++){const H=F[W],Y=g(H),V=S%C,te=V%Y.boundary,ce=V+te;S+=te,ce!==0&&C-ce<Y.storage&&(S+=C-ce),O.__data=new Float32Array(Y.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=S,S+=Y.storage}}}const A=S%C;return A>0&&(S+=C-A),E.__size=S,E.__cache={},this}function g(E){const T={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(T.boundary=4,T.storage=4):E.isVector2?(T.boundary=8,T.storage=8):E.isVector3||E.isColor?(T.boundary=16,T.storage=12):E.isVector4?(T.boundary=16,T.storage=16):E.isMatrix3?(T.boundary=48,T.storage=48):E.isMatrix4?(T.boundary=64,T.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),T}function m(E){const T=E.target;T.removeEventListener("dispose",m);const S=a.indexOf(T.__bindingPointIndex);a.splice(S,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function d(){for(const E in r)i.deleteBuffer(r[E]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}class m_{constructor(e={}){const{canvas:t=Yh(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;const _=new Uint32Array(4),g=new Int32Array(4);let m=null,d=null;const E=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ct,this.toneMapping=Tn,this.toneMappingExposure=1;const S=this;let C=!1,A=0,R=0,D=null,y=-1,x=null;const w=new lt,O=new lt;let F=null;const W=new Ke(0);let X=0,H=t.width,Y=t.height,V=1,te=null,ce=null;const ge=new lt(0,0,H,Y),Ne=new lt(0,0,H,Y);let $e=!1;const j=new tc;let ee=!1,me=!1;const se=new at,Te=new at,Re=new L,Fe=new lt,nt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ke=!1;function ot(){return D===null?V:1}let P=n;function Ft(M,I){return t.getContext(M,I)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ca}`),t.addEventListener("webglcontextlost",K,!1),t.addEventListener("webglcontextrestored",le,!1),t.addEventListener("webglcontextcreationerror",oe,!1),P===null){const I="webgl2";if(P=Ft(I,M),P===null)throw Ft(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let Oe,Be,ve,et,xe,b,v,B,Z,$,q,_e,ae,ue,He,Q,de,Ee,be,fe,ze,Le,Je,U;function ie(){Oe=new Tp(P),Oe.init(),Le=new a_(P,Oe),Be=new vp(P,Oe,e,Le),ve=new r_(P,Oe),Be.reverseDepthBuffer&&f&&ve.buffers.depth.setReversed(!0),et=new Ap(P),xe=new Xm,b=new s_(P,Oe,ve,xe,Be,Le,et),v=new yp(S),B=new Ep(S),Z=new Uu(P),Je=new _p(P,Z),$=new bp(P,Z,et,Je),q=new Rp(P,$,Z,et),be=new Cp(P,Be,b),Q=new xp(xe),_e=new Wm(S,v,B,Oe,Be,Je,Q),ae=new f_(S,xe),ue=new qm,He=new Qm(Oe),Ee=new mp(S,v,B,ve,q,p,l),de=new n_(S,q,Be),U=new p_(P,et,Be,ve),fe=new gp(P,Oe,et),ze=new wp(P,Oe,et),et.programs=_e.programs,S.capabilities=Be,S.extensions=Oe,S.properties=xe,S.renderLists=ue,S.shadowMap=de,S.state=ve,S.info=et}ie();const G=new u_(S,P);this.xr=G,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const M=Oe.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=Oe.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(M){M!==void 0&&(V=M,this.setSize(H,Y,!1))},this.getSize=function(M){return M.set(H,Y)},this.setSize=function(M,I,z=!0){if(G.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=M,Y=I,t.width=Math.floor(M*V),t.height=Math.floor(I*V),z===!0&&(t.style.width=M+"px",t.style.height=I+"px"),this.setViewport(0,0,M,I)},this.getDrawingBufferSize=function(M){return M.set(H*V,Y*V).floor()},this.setDrawingBufferSize=function(M,I,z){H=M,Y=I,V=z,t.width=Math.floor(M*z),t.height=Math.floor(I*z),this.setViewport(0,0,M,I)},this.getCurrentViewport=function(M){return M.copy(w)},this.getViewport=function(M){return M.copy(ge)},this.setViewport=function(M,I,z,k){M.isVector4?ge.set(M.x,M.y,M.z,M.w):ge.set(M,I,z,k),ve.viewport(w.copy(ge).multiplyScalar(V).round())},this.getScissor=function(M){return M.copy(Ne)},this.setScissor=function(M,I,z,k){M.isVector4?Ne.set(M.x,M.y,M.z,M.w):Ne.set(M,I,z,k),ve.scissor(O.copy(Ne).multiplyScalar(V).round())},this.getScissorTest=function(){return $e},this.setScissorTest=function(M){ve.setScissorTest($e=M)},this.setOpaqueSort=function(M){te=M},this.setTransparentSort=function(M){ce=M},this.getClearColor=function(M){return M.copy(Ee.getClearColor())},this.setClearColor=function(){Ee.setClearColor.apply(Ee,arguments)},this.getClearAlpha=function(){return Ee.getClearAlpha()},this.setClearAlpha=function(){Ee.setClearAlpha.apply(Ee,arguments)},this.clear=function(M=!0,I=!0,z=!0){let k=0;if(M){let N=!1;if(D!==null){const J=D.texture.format;N=J===Ia||J===Ua||J===La}if(N){const J=D.texture.type,re=J===un||J===Wn||J===Vi||J===Ei||J===Pa||J===Da,he=Ee.getClearColor(),pe=Ee.getClearAlpha(),we=he.r,Ce=he.g,ye=he.b;re?(_[0]=we,_[1]=Ce,_[2]=ye,_[3]=pe,P.clearBufferuiv(P.COLOR,0,_)):(g[0]=we,g[1]=Ce,g[2]=ye,g[3]=pe,P.clearBufferiv(P.COLOR,0,g))}else k|=P.COLOR_BUFFER_BIT}I&&(k|=P.DEPTH_BUFFER_BIT),z&&(k|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",K,!1),t.removeEventListener("webglcontextrestored",le,!1),t.removeEventListener("webglcontextcreationerror",oe,!1),Ee.dispose(),ue.dispose(),He.dispose(),xe.dispose(),v.dispose(),B.dispose(),q.dispose(),Je.dispose(),U.dispose(),_e.dispose(),G.dispose(),G.removeEventListener("sessionstart",qa),G.removeEventListener("sessionend",ja),wn.stop()};function K(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),C=!0}function le(){console.log("THREE.WebGLRenderer: Context Restored."),C=!1;const M=et.autoReset,I=de.enabled,z=de.autoUpdate,k=de.needsUpdate,N=de.type;ie(),et.autoReset=M,de.enabled=I,de.autoUpdate=z,de.needsUpdate=k,de.type=N}function oe(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function Pe(M){const I=M.target;I.removeEventListener("dispose",Pe),it(I)}function it(M){gt(M),xe.remove(M)}function gt(M){const I=xe.get(M).programs;I!==void 0&&(I.forEach(function(z){_e.releaseProgram(z)}),M.isShaderMaterial&&_e.releaseShaderCache(M))}this.renderBufferDirect=function(M,I,z,k,N,J){I===null&&(I=nt);const re=N.isMesh&&N.matrixWorld.determinant()<0,he=_c(M,I,z,k,N);ve.setMaterial(k,re);let pe=z.index,we=1;if(k.wireframe===!0){if(pe=$.getWireframeAttribute(z),pe===void 0)return;we=2}const Ce=z.drawRange,ye=z.attributes.position;let Ve=Ce.start*we,Xe=(Ce.start+Ce.count)*we;J!==null&&(Ve=Math.max(Ve,J.start*we),Xe=Math.min(Xe,(J.start+J.count)*we)),pe!==null?(Ve=Math.max(Ve,0),Xe=Math.min(Xe,pe.count)):ye!=null&&(Ve=Math.max(Ve,0),Xe=Math.min(Xe,ye.count));const ct=Xe-Ve;if(ct<0||ct===1/0)return;Je.setup(N,k,he,z,pe);let rt,Ge=fe;if(pe!==null&&(rt=Z.get(pe),Ge=ze,Ge.setIndex(rt)),N.isMesh)k.wireframe===!0?(ve.setLineWidth(k.wireframeLinewidth*ot()),Ge.setMode(P.LINES)):Ge.setMode(P.TRIANGLES);else if(N.isLine){let Me=k.linewidth;Me===void 0&&(Me=1),ve.setLineWidth(Me*ot()),N.isLineSegments?Ge.setMode(P.LINES):N.isLineLoop?Ge.setMode(P.LINE_LOOP):Ge.setMode(P.LINE_STRIP)}else N.isPoints?Ge.setMode(P.POINTS):N.isSprite&&Ge.setMode(P.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Ge.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(Oe.get("WEBGL_multi_draw"))Ge.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Me=N._multiDrawStarts,mt=N._multiDrawCounts,Ye=N._multiDrawCount,Gt=pe?Z.get(pe).bytesPerElement:1,jn=xe.get(k).currentProgram.getUniforms();for(let Dt=0;Dt<Ye;Dt++)jn.setValue(P,"_gl_DrawID",Dt),Ge.render(Me[Dt]/Gt,mt[Dt])}else if(N.isInstancedMesh)Ge.renderInstances(Ve,ct,N.count);else if(z.isInstancedBufferGeometry){const Me=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,mt=Math.min(z.instanceCount,Me);Ge.renderInstances(Ve,ct,mt)}else Ge.render(Ve,ct)};function qe(M,I,z){M.transparent===!0&&M.side===an&&M.forceSinglePass===!1?(M.side=Pt,M.needsUpdate=!0,Ki(M,I,z),M.side=bn,M.needsUpdate=!0,Ki(M,I,z),M.side=an):Ki(M,I,z)}this.compile=function(M,I,z=null){z===null&&(z=M),d=He.get(z),d.init(I),T.push(d),z.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(d.pushLight(N),N.castShadow&&d.pushShadow(N))}),M!==z&&M.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(d.pushLight(N),N.castShadow&&d.pushShadow(N))}),d.setupLights();const k=new Set;return M.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const J=N.material;if(J)if(Array.isArray(J))for(let re=0;re<J.length;re++){const he=J[re];qe(he,z,N),k.add(he)}else qe(J,z,N),k.add(J)}),T.pop(),d=null,k},this.compileAsync=function(M,I,z=null){const k=this.compile(M,I,z);return new Promise(N=>{function J(){if(k.forEach(function(re){xe.get(re).currentProgram.isReady()&&k.delete(re)}),k.size===0){N(M);return}setTimeout(J,10)}Oe.get("KHR_parallel_shader_compile")!==null?J():setTimeout(J,10)})};let Vt=null;function Jt(M){Vt&&Vt(M)}function qa(){wn.stop()}function ja(){wn.start()}const wn=new ic;wn.setAnimationLoop(Jt),typeof self<"u"&&wn.setContext(self),this.setAnimationLoop=function(M){Vt=M,G.setAnimationLoop(M),M===null?wn.stop():wn.start()},G.addEventListener("sessionstart",qa),G.addEventListener("sessionend",ja),this.render=function(M,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),G.enabled===!0&&G.isPresenting===!0&&(G.cameraAutoUpdate===!0&&G.updateCamera(I),I=G.getCamera()),M.isScene===!0&&M.onBeforeRender(S,M,I,D),d=He.get(M,T.length),d.init(I),T.push(d),Te.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),j.setFromProjectionMatrix(Te),me=this.localClippingEnabled,ee=Q.init(this.clippingPlanes,me),m=ue.get(M,E.length),m.init(),E.push(m),G.enabled===!0&&G.isPresenting===!0){const J=S.xr.getDepthSensingMesh();J!==null&&Gr(J,I,-1/0,S.sortObjects)}Gr(M,I,0,S.sortObjects),m.finish(),S.sortObjects===!0&&m.sort(te,ce),ke=G.enabled===!1||G.isPresenting===!1||G.hasDepthSensing()===!1,ke&&Ee.addToRenderList(m,M),this.info.render.frame++,ee===!0&&Q.beginShadows();const z=d.state.shadowsArray;de.render(z,M,I),ee===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=m.opaque,N=m.transmissive;if(d.setupLights(),I.isArrayCamera){const J=I.cameras;if(N.length>0)for(let re=0,he=J.length;re<he;re++){const pe=J[re];Ka(k,N,M,pe)}ke&&Ee.render(M);for(let re=0,he=J.length;re<he;re++){const pe=J[re];Za(m,M,pe,pe.viewport)}}else N.length>0&&Ka(k,N,M,I),ke&&Ee.render(M),Za(m,M,I);D!==null&&(b.updateMultisampleRenderTarget(D),b.updateRenderTargetMipmap(D)),M.isScene===!0&&M.onAfterRender(S,M,I),Je.resetDefaultState(),y=-1,x=null,T.pop(),T.length>0?(d=T[T.length-1],ee===!0&&Q.setGlobalState(S.clippingPlanes,d.state.camera)):d=null,E.pop(),E.length>0?m=E[E.length-1]:m=null};function Gr(M,I,z,k){if(M.visible===!1)return;if(M.layers.test(I.layers)){if(M.isGroup)z=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(I);else if(M.isLight)d.pushLight(M),M.castShadow&&d.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||j.intersectsSprite(M)){k&&Fe.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Te);const re=q.update(M),he=M.material;he.visible&&m.push(M,re,he,z,Fe.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||j.intersectsObject(M))){const re=q.update(M),he=M.material;if(k&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Fe.copy(M.boundingSphere.center)):(re.boundingSphere===null&&re.computeBoundingSphere(),Fe.copy(re.boundingSphere.center)),Fe.applyMatrix4(M.matrixWorld).applyMatrix4(Te)),Array.isArray(he)){const pe=re.groups;for(let we=0,Ce=pe.length;we<Ce;we++){const ye=pe[we],Ve=he[ye.materialIndex];Ve&&Ve.visible&&m.push(M,re,Ve,z,Fe.z,ye)}}else he.visible&&m.push(M,re,he,z,Fe.z,null)}}const J=M.children;for(let re=0,he=J.length;re<he;re++)Gr(J[re],I,z,k)}function Za(M,I,z,k){const N=M.opaque,J=M.transmissive,re=M.transparent;d.setupLightsView(z),ee===!0&&Q.setGlobalState(S.clippingPlanes,z),k&&ve.viewport(w.copy(k)),N.length>0&&Zi(N,I,z),J.length>0&&Zi(J,I,z),re.length>0&&Zi(re,I,z),ve.buffers.depth.setTest(!0),ve.buffers.depth.setMask(!0),ve.buffers.color.setMask(!0),ve.setPolygonOffset(!1)}function Ka(M,I,z,k){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[k.id]===void 0&&(d.state.transmissionRenderTarget[k.id]=new Xn(1,1,{generateMipmaps:!0,type:Oe.has("EXT_color_buffer_half_float")||Oe.has("EXT_color_buffer_float")?Yi:un,minFilter:Vn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:We.workingColorSpace}));const J=d.state.transmissionRenderTarget[k.id],re=k.viewport||w;J.setSize(re.z,re.w);const he=S.getRenderTarget();S.setRenderTarget(J),S.getClearColor(W),X=S.getClearAlpha(),X<1&&S.setClearColor(16777215,.5),S.clear(),ke&&Ee.render(z);const pe=S.toneMapping;S.toneMapping=Tn;const we=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),d.setupLightsView(k),ee===!0&&Q.setGlobalState(S.clippingPlanes,k),Zi(M,z,k),b.updateMultisampleRenderTarget(J),b.updateRenderTargetMipmap(J),Oe.has("WEBGL_multisampled_render_to_texture")===!1){let Ce=!1;for(let ye=0,Ve=I.length;ye<Ve;ye++){const Xe=I[ye],ct=Xe.object,rt=Xe.geometry,Ge=Xe.material,Me=Xe.group;if(Ge.side===an&&ct.layers.test(k.layers)){const mt=Ge.side;Ge.side=Pt,Ge.needsUpdate=!0,$a(ct,z,k,rt,Ge,Me),Ge.side=mt,Ge.needsUpdate=!0,Ce=!0}}Ce===!0&&(b.updateMultisampleRenderTarget(J),b.updateRenderTargetMipmap(J))}S.setRenderTarget(he),S.setClearColor(W,X),we!==void 0&&(k.viewport=we),S.toneMapping=pe}function Zi(M,I,z){const k=I.isScene===!0?I.overrideMaterial:null;for(let N=0,J=M.length;N<J;N++){const re=M[N],he=re.object,pe=re.geometry,we=k===null?re.material:k,Ce=re.group;he.layers.test(z.layers)&&$a(he,I,z,pe,we,Ce)}}function $a(M,I,z,k,N,J){M.onBeforeRender(S,I,z,k,N,J),M.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(S,I,z,k,M,J),N.transparent===!0&&N.side===an&&N.forceSinglePass===!1?(N.side=Pt,N.needsUpdate=!0,S.renderBufferDirect(z,I,k,N,M,J),N.side=bn,N.needsUpdate=!0,S.renderBufferDirect(z,I,k,N,M,J),N.side=an):S.renderBufferDirect(z,I,k,N,M,J),M.onAfterRender(S,I,z,k,N,J)}function Ki(M,I,z){I.isScene!==!0&&(I=nt);const k=xe.get(M),N=d.state.lights,J=d.state.shadowsArray,re=N.state.version,he=_e.getParameters(M,N.state,J,I,z),pe=_e.getProgramCacheKey(he);let we=k.programs;k.environment=M.isMeshStandardMaterial?I.environment:null,k.fog=I.fog,k.envMap=(M.isMeshStandardMaterial?B:v).get(M.envMap||k.environment),k.envMapRotation=k.environment!==null&&M.envMap===null?I.environmentRotation:M.envMapRotation,we===void 0&&(M.addEventListener("dispose",Pe),we=new Map,k.programs=we);let Ce=we.get(pe);if(Ce!==void 0){if(k.currentProgram===Ce&&k.lightsStateVersion===re)return Qa(M,he),Ce}else he.uniforms=_e.getUniforms(M),M.onBeforeCompile(he,S),Ce=_e.acquireProgram(he,pe),we.set(pe,Ce),k.uniforms=he.uniforms;const ye=k.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(ye.clippingPlanes=Q.uniform),Qa(M,he),k.needsLights=vc(M),k.lightsStateVersion=re,k.needsLights&&(ye.ambientLightColor.value=N.state.ambient,ye.lightProbe.value=N.state.probe,ye.directionalLights.value=N.state.directional,ye.directionalLightShadows.value=N.state.directionalShadow,ye.spotLights.value=N.state.spot,ye.spotLightShadows.value=N.state.spotShadow,ye.rectAreaLights.value=N.state.rectArea,ye.ltc_1.value=N.state.rectAreaLTC1,ye.ltc_2.value=N.state.rectAreaLTC2,ye.pointLights.value=N.state.point,ye.pointLightShadows.value=N.state.pointShadow,ye.hemisphereLights.value=N.state.hemi,ye.directionalShadowMap.value=N.state.directionalShadowMap,ye.directionalShadowMatrix.value=N.state.directionalShadowMatrix,ye.spotShadowMap.value=N.state.spotShadowMap,ye.spotLightMatrix.value=N.state.spotLightMatrix,ye.spotLightMap.value=N.state.spotLightMap,ye.pointShadowMap.value=N.state.pointShadowMap,ye.pointShadowMatrix.value=N.state.pointShadowMatrix),k.currentProgram=Ce,k.uniformsList=null,Ce}function Ja(M){if(M.uniformsList===null){const I=M.currentProgram.getUniforms();M.uniformsList=Dr.seqWithValue(I.seq,M.uniforms)}return M.uniformsList}function Qa(M,I){const z=xe.get(M);z.outputColorSpace=I.outputColorSpace,z.batching=I.batching,z.batchingColor=I.batchingColor,z.instancing=I.instancing,z.instancingColor=I.instancingColor,z.instancingMorph=I.instancingMorph,z.skinning=I.skinning,z.morphTargets=I.morphTargets,z.morphNormals=I.morphNormals,z.morphColors=I.morphColors,z.morphTargetsCount=I.morphTargetsCount,z.numClippingPlanes=I.numClippingPlanes,z.numIntersection=I.numClipIntersection,z.vertexAlphas=I.vertexAlphas,z.vertexTangents=I.vertexTangents,z.toneMapping=I.toneMapping}function _c(M,I,z,k,N){I.isScene!==!0&&(I=nt),b.resetTextureUnits();const J=I.fog,re=k.isMeshStandardMaterial?I.environment:null,he=D===null?S.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:bi,pe=(k.isMeshStandardMaterial?B:v).get(k.envMap||re),we=k.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,Ce=!!z.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),ye=!!z.morphAttributes.position,Ve=!!z.morphAttributes.normal,Xe=!!z.morphAttributes.color;let ct=Tn;k.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(ct=S.toneMapping);const rt=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,Ge=rt!==void 0?rt.length:0,Me=xe.get(k),mt=d.state.lights;if(ee===!0&&(me===!0||M!==x)){const Mt=M===x&&k.id===y;Q.setState(k,M,Mt)}let Ye=!1;k.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==mt.state.version||Me.outputColorSpace!==he||N.isBatchedMesh&&Me.batching===!1||!N.isBatchedMesh&&Me.batching===!0||N.isBatchedMesh&&Me.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Me.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Me.instancing===!1||!N.isInstancedMesh&&Me.instancing===!0||N.isSkinnedMesh&&Me.skinning===!1||!N.isSkinnedMesh&&Me.skinning===!0||N.isInstancedMesh&&Me.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Me.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Me.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Me.instancingMorph===!1&&N.morphTexture!==null||Me.envMap!==pe||k.fog===!0&&Me.fog!==J||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==Q.numPlanes||Me.numIntersection!==Q.numIntersection)||Me.vertexAlphas!==we||Me.vertexTangents!==Ce||Me.morphTargets!==ye||Me.morphNormals!==Ve||Me.morphColors!==Xe||Me.toneMapping!==ct||Me.morphTargetsCount!==Ge)&&(Ye=!0):(Ye=!0,Me.__version=k.version);let Gt=Me.currentProgram;Ye===!0&&(Gt=Ki(k,I,N));let jn=!1,Dt=!1,Ri=!1;const tt=Gt.getUniforms(),Ot=Me.uniforms;if(ve.useProgram(Gt.program)&&(jn=!0,Dt=!0,Ri=!0),k.id!==y&&(y=k.id,Dt=!0),jn||x!==M){ve.buffers.depth.getReversed()?(se.copy(M.projectionMatrix),jh(se),Zh(se),tt.setValue(P,"projectionMatrix",se)):tt.setValue(P,"projectionMatrix",M.projectionMatrix),tt.setValue(P,"viewMatrix",M.matrixWorldInverse);const wt=tt.map.cameraPosition;wt!==void 0&&wt.setValue(P,Re.setFromMatrixPosition(M.matrixWorld)),Be.logarithmicDepthBuffer&&tt.setValue(P,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&tt.setValue(P,"isOrthographic",M.isOrthographicCamera===!0),x!==M&&(x=M,Dt=!0,Ri=!0)}if(N.isSkinnedMesh){tt.setOptional(P,N,"bindMatrix"),tt.setOptional(P,N,"bindMatrixInverse");const Mt=N.skeleton;Mt&&(Mt.boneTexture===null&&Mt.computeBoneTexture(),tt.setValue(P,"boneTexture",Mt.boneTexture,b))}N.isBatchedMesh&&(tt.setOptional(P,N,"batchingTexture"),tt.setValue(P,"batchingTexture",N._matricesTexture,b),tt.setOptional(P,N,"batchingIdTexture"),tt.setValue(P,"batchingIdTexture",N._indirectTexture,b),tt.setOptional(P,N,"batchingColorTexture"),N._colorsTexture!==null&&tt.setValue(P,"batchingColorTexture",N._colorsTexture,b));const Bt=z.morphAttributes;if((Bt.position!==void 0||Bt.normal!==void 0||Bt.color!==void 0)&&be.update(N,z,Gt),(Dt||Me.receiveShadow!==N.receiveShadow)&&(Me.receiveShadow=N.receiveShadow,tt.setValue(P,"receiveShadow",N.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Ot.envMap.value=pe,Ot.flipEnvMap.value=pe.isCubeTexture&&pe.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&I.environment!==null&&(Ot.envMapIntensity.value=I.environmentIntensity),Dt&&(tt.setValue(P,"toneMappingExposure",S.toneMappingExposure),Me.needsLights&&gc(Ot,Ri),J&&k.fog===!0&&ae.refreshFogUniforms(Ot,J),ae.refreshMaterialUniforms(Ot,k,V,Y,d.state.transmissionRenderTarget[M.id]),Dr.upload(P,Ja(Me),Ot,b)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Dr.upload(P,Ja(Me),Ot,b),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&tt.setValue(P,"center",N.center),tt.setValue(P,"modelViewMatrix",N.modelViewMatrix),tt.setValue(P,"normalMatrix",N.normalMatrix),tt.setValue(P,"modelMatrix",N.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Mt=k.uniformsGroups;for(let wt=0,Wr=Mt.length;wt<Wr;wt++){const An=Mt[wt];U.update(An,Gt),U.bind(An,Gt)}}return Gt}function gc(M,I){M.ambientLightColor.needsUpdate=I,M.lightProbe.needsUpdate=I,M.directionalLights.needsUpdate=I,M.directionalLightShadows.needsUpdate=I,M.pointLights.needsUpdate=I,M.pointLightShadows.needsUpdate=I,M.spotLights.needsUpdate=I,M.spotLightShadows.needsUpdate=I,M.rectAreaLights.needsUpdate=I,M.hemisphereLights.needsUpdate=I}function vc(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(M,I,z){xe.get(M.texture).__webglTexture=I,xe.get(M.depthTexture).__webglTexture=z;const k=xe.get(M);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=z===void 0,k.__autoAllocateDepthBuffer||Oe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(M,I){const z=xe.get(M);z.__webglFramebuffer=I,z.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(M,I=0,z=0){D=M,A=I,R=z;let k=!0,N=null,J=!1,re=!1;if(M){const pe=xe.get(M);if(pe.__useDefaultFramebuffer!==void 0)ve.bindFramebuffer(P.FRAMEBUFFER,null),k=!1;else if(pe.__webglFramebuffer===void 0)b.setupRenderTarget(M);else if(pe.__hasExternalTextures)b.rebindTextures(M,xe.get(M.texture).__webglTexture,xe.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const ye=M.depthTexture;if(pe.__boundDepthTexture!==ye){if(ye!==null&&xe.has(ye)&&(M.width!==ye.image.width||M.height!==ye.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");b.setupDepthRenderbuffer(M)}}const we=M.texture;(we.isData3DTexture||we.isDataArrayTexture||we.isCompressedArrayTexture)&&(re=!0);const Ce=xe.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Ce[I])?N=Ce[I][z]:N=Ce[I],J=!0):M.samples>0&&b.useMultisampledRTT(M)===!1?N=xe.get(M).__webglMultisampledFramebuffer:Array.isArray(Ce)?N=Ce[z]:N=Ce,w.copy(M.viewport),O.copy(M.scissor),F=M.scissorTest}else w.copy(ge).multiplyScalar(V).floor(),O.copy(Ne).multiplyScalar(V).floor(),F=$e;if(ve.bindFramebuffer(P.FRAMEBUFFER,N)&&k&&ve.drawBuffers(M,N),ve.viewport(w),ve.scissor(O),ve.setScissorTest(F),J){const pe=xe.get(M.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+I,pe.__webglTexture,z)}else if(re){const pe=xe.get(M.texture),we=I||0;P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,pe.__webglTexture,z||0,we)}y=-1},this.readRenderTargetPixels=function(M,I,z,k,N,J,re){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let he=xe.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&re!==void 0&&(he=he[re]),he){ve.bindFramebuffer(P.FRAMEBUFFER,he);try{const pe=M.texture,we=pe.format,Ce=pe.type;if(!Be.textureFormatReadable(we)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Be.textureTypeReadable(Ce)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=M.width-k&&z>=0&&z<=M.height-N&&P.readPixels(I,z,k,N,Le.convert(we),Le.convert(Ce),J)}finally{const pe=D!==null?xe.get(D).__webglFramebuffer:null;ve.bindFramebuffer(P.FRAMEBUFFER,pe)}}},this.readRenderTargetPixelsAsync=async function(M,I,z,k,N,J,re){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let he=xe.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&re!==void 0&&(he=he[re]),he){const pe=M.texture,we=pe.format,Ce=pe.type;if(!Be.textureFormatReadable(we))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Be.textureTypeReadable(Ce))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(I>=0&&I<=M.width-k&&z>=0&&z<=M.height-N){ve.bindFramebuffer(P.FRAMEBUFFER,he);const ye=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,ye),P.bufferData(P.PIXEL_PACK_BUFFER,J.byteLength,P.STREAM_READ),P.readPixels(I,z,k,N,Le.convert(we),Le.convert(Ce),0);const Ve=D!==null?xe.get(D).__webglFramebuffer:null;ve.bindFramebuffer(P.FRAMEBUFFER,Ve);const Xe=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await qh(P,Xe,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,ye),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,J),P.deleteBuffer(ye),P.deleteSync(Xe),J}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(M,I=null,z=0){M.isTexture!==!0&&(ui("WebGLRenderer: copyFramebufferToTexture function signature has changed."),I=arguments[0]||null,M=arguments[1]);const k=Math.pow(2,-z),N=Math.floor(M.image.width*k),J=Math.floor(M.image.height*k),re=I!==null?I.x:0,he=I!==null?I.y:0;b.setTexture2D(M,0),P.copyTexSubImage2D(P.TEXTURE_2D,z,0,0,re,he,N,J),ve.unbindTexture()};const xc=P.createFramebuffer(),yc=P.createFramebuffer();this.copyTextureToTexture=function(M,I,z=null,k=null,N=0,J=null){M.isTexture!==!0&&(ui("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,M=arguments[1],I=arguments[2],J=arguments[3]||0,z=null),J===null&&(N!==0?(ui("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),J=N,N=0):J=0);let re,he,pe,we,Ce,ye,Ve,Xe,ct;const rt=M.isCompressedTexture?M.mipmaps[J]:M.image;if(z!==null)re=z.max.x-z.min.x,he=z.max.y-z.min.y,pe=z.isBox3?z.max.z-z.min.z:1,we=z.min.x,Ce=z.min.y,ye=z.isBox3?z.min.z:0;else{const Bt=Math.pow(2,-N);re=Math.floor(rt.width*Bt),he=Math.floor(rt.height*Bt),M.isDataArrayTexture?pe=rt.depth:M.isData3DTexture?pe=Math.floor(rt.depth*Bt):pe=1,we=0,Ce=0,ye=0}k!==null?(Ve=k.x,Xe=k.y,ct=k.z):(Ve=0,Xe=0,ct=0);const Ge=Le.convert(I.format),Me=Le.convert(I.type);let mt;I.isData3DTexture?(b.setTexture3D(I,0),mt=P.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(b.setTexture2DArray(I,0),mt=P.TEXTURE_2D_ARRAY):(b.setTexture2D(I,0),mt=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,I.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,I.unpackAlignment);const Ye=P.getParameter(P.UNPACK_ROW_LENGTH),Gt=P.getParameter(P.UNPACK_IMAGE_HEIGHT),jn=P.getParameter(P.UNPACK_SKIP_PIXELS),Dt=P.getParameter(P.UNPACK_SKIP_ROWS),Ri=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,rt.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,rt.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,we),P.pixelStorei(P.UNPACK_SKIP_ROWS,Ce),P.pixelStorei(P.UNPACK_SKIP_IMAGES,ye);const tt=M.isDataArrayTexture||M.isData3DTexture,Ot=I.isDataArrayTexture||I.isData3DTexture;if(M.isDepthTexture){const Bt=xe.get(M),Mt=xe.get(I),wt=xe.get(Bt.__renderTarget),Wr=xe.get(Mt.__renderTarget);ve.bindFramebuffer(P.READ_FRAMEBUFFER,wt.__webglFramebuffer),ve.bindFramebuffer(P.DRAW_FRAMEBUFFER,Wr.__webglFramebuffer);for(let An=0;An<pe;An++)tt&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,xe.get(M).__webglTexture,N,ye+An),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,xe.get(I).__webglTexture,J,ct+An)),P.blitFramebuffer(we,Ce,re,he,Ve,Xe,re,he,P.DEPTH_BUFFER_BIT,P.NEAREST);ve.bindFramebuffer(P.READ_FRAMEBUFFER,null),ve.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(N!==0||M.isRenderTargetTexture||xe.has(M)){const Bt=xe.get(M),Mt=xe.get(I);ve.bindFramebuffer(P.READ_FRAMEBUFFER,xc),ve.bindFramebuffer(P.DRAW_FRAMEBUFFER,yc);for(let wt=0;wt<pe;wt++)tt?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Bt.__webglTexture,N,ye+wt):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Bt.__webglTexture,N),Ot?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Mt.__webglTexture,J,ct+wt):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Mt.__webglTexture,J),N!==0?P.blitFramebuffer(we,Ce,re,he,Ve,Xe,re,he,P.COLOR_BUFFER_BIT,P.NEAREST):Ot?P.copyTexSubImage3D(mt,J,Ve,Xe,ct+wt,we,Ce,re,he):P.copyTexSubImage2D(mt,J,Ve,Xe,we,Ce,re,he);ve.bindFramebuffer(P.READ_FRAMEBUFFER,null),ve.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else Ot?M.isDataTexture||M.isData3DTexture?P.texSubImage3D(mt,J,Ve,Xe,ct,re,he,pe,Ge,Me,rt.data):I.isCompressedArrayTexture?P.compressedTexSubImage3D(mt,J,Ve,Xe,ct,re,he,pe,Ge,rt.data):P.texSubImage3D(mt,J,Ve,Xe,ct,re,he,pe,Ge,Me,rt):M.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,J,Ve,Xe,re,he,Ge,Me,rt.data):M.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,J,Ve,Xe,rt.width,rt.height,Ge,rt.data):P.texSubImage2D(P.TEXTURE_2D,J,Ve,Xe,re,he,Ge,Me,rt);P.pixelStorei(P.UNPACK_ROW_LENGTH,Ye),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Gt),P.pixelStorei(P.UNPACK_SKIP_PIXELS,jn),P.pixelStorei(P.UNPACK_SKIP_ROWS,Dt),P.pixelStorei(P.UNPACK_SKIP_IMAGES,Ri),J===0&&I.generateMipmaps&&P.generateMipmap(mt),ve.unbindTexture()},this.copyTextureToTexture3D=function(M,I,z=null,k=null,N=0){return M.isTexture!==!0&&(ui("WebGLRenderer: copyTextureToTexture3D function signature has changed."),z=arguments[0]||null,k=arguments[1]||null,M=arguments[2],I=arguments[3],N=arguments[4]||0),ui('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,I,z,k,N)},this.initRenderTarget=function(M){xe.get(M).__webglFramebuffer===void 0&&b.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?b.setTextureCube(M,0):M.isData3DTexture?b.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?b.setTexture2DArray(M,0):b.setTexture2D(M,0),ve.unbindTexture()},this.resetState=function(){A=0,R=0,D=null,ve.reset(),Je.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=We._getDrawingBufferColorSpace(e),t.unpackColorSpace=We._getUnpackColorSpace()}}function kn(i,e){const t=i*Math.PI/180,n=-e*Math.PI/180;return new L(Math.cos(t)*Math.cos(n),Math.sin(t),Math.cos(t)*Math.sin(n))}function Va(i){const e=Math.asin(i.y/1)*(180/Math.PI),t=-Math.atan2(i.z,i.x)*(180/Math.PI);return[e,t]}function lc(i){const t=i.map(([n,r])=>kn(n,r)).reduce((n,r)=>n.add(r),new L).normalize();return Va(t)}function __(i,e){const t=Ll([[...e,e[0]].map(([n,r])=>[r,n])]);return kc(Ls([i[1],i[0]]),t)}const g_=["none","arrow","area","edit"];class v_{constructor(e){Se(this,"mode","none");Se(this,"earth");Se(this,"coordinates",[]);Se(this,"index",-1);Se(this,"name","");Se(this,"shape");Se(this,"originalArea");this.earth=e,document.addEventListener("keyup",t=>{var n,r;t.key==="Delete"?(this.coordinates.length=0,this.shape&&(this.shape.remove(),this.shape=void 0)):t.key==="Backspace"?this.coordinates.length>0&&(this.coordinates.splice(this.index,1),this.index--,this.index<0&&(this.index=0),this.index>=this.coordinates.length&&(this.index=this.coordinates.length-1),this.updateShape()):t.key==="Escape"&&this.mode==="area"&&(this.mode="edit",this.coordinates=[],this.index=-1,this.name="",(n=this.shape)==null||n.remove(),this.shape=void 0,this.originalArea&&(this.earth.addArea(this.originalArea.coordinates,((r=this.originalArea.label)==null?void 0:r.element.innerText)||""),this.originalArea=void 0))})}onClick(e,t){var n;if(this.mode!=="none"){if(this.mode==="edit"){const r=this.earth.areas.find(s=>__(e,s.coordinates));r&&(this.coordinates=r.coordinates,this.index=r.coordinates.length-1,this.mode="area",this.name=((n=r.label)==null?void 0:n.element.innerText)||"",this.shape=r,this.originalArea=r)}else if(t===0)this.coordinates.splice(this.index+1,0,e),this.index++;else if(t===2){let r=0,s=1/0;for(let a=0;a<this.coordinates.length;a++){const o=Math.hypot(this.coordinates[a][0]-e[0],this.coordinates[a][1]-e[1]);o<s&&(r=a,s=o)}this.index=r}this.updateShape()}}updateShape(){console.log(this.coordinates.map(e=>`${e[0].toFixed(2)},${e[1].toFixed(2)}`).join(`
`)),this.shape&&(this.shape.remove(),this.shape=void 0),this.coordinates.length>=2&&(this.mode==="arrow"?this.shape=this.earth.addArrow(this.coordinates,this.name):this.mode==="area"&&(this.shape=this.earth.addArea(this.coordinates,this.name,void 0,{index:this.index})))}}const x_=document.getElementById("controls");function y_(i,e,t){document.addEventListener("keyup",n=>{n.key==="ArrowLeft"?i.skipToPreviousEvent():n.key==="ArrowRight"&&i.skipToNextEvent()}),Aa(st(M_,{history:i,earth:e,editor:t}),x_)}function M_({history:i,earth:e,editor:t}){return st("div",{className:"flex gap-5 justify-center",children:[st("select",{onChange:n=>{e.setVisualisation(parseInt(n.currentTarget.value))},children:[st("option",{value:"0",children:"Earth"}),st("option",{value:"1",children:"Max temperature"}),st("option",{value:"2",children:"Min temperature"}),st("option",{value:"3",children:"Precipitation"})]}),st("select",{onChange:n=>{t.mode=n.currentTarget.value},children:g_.map(n=>st("option",{value:n,children:n}))}),st(ro,{onClick:()=>i.skipToPreviousEvent(),children:"Previous"}),st(ro,{onClick:()=>i.skipToNextEvent(),children:"Next"}),st("input",{type:"range",min:"0",max:"1",step:"0.01",value:e.projectionBlend,onInput:n=>{e.setProjectionBlend(parseFloat(n.currentTarget.value))}})]})}const hl=Math.pow(2,-52),Mr=new Uint32Array(512);class Ga{static from(e,t=w_,n=A_){const r=e.length,s=new Float64Array(r*2);for(let a=0;a<r;a++){const o=e[a];s[2*a]=t(o),s[2*a+1]=n(o)}return new Ga(s)}constructor(e){const t=e.length>>1;if(t>0&&typeof e[0]!="number")throw new Error("Expected coords to contain numbers.");this.coords=e;const n=Math.max(2*t-5,0);this._triangles=new Uint32Array(n*3),this._halfedges=new Int32Array(n*3),this._hashSize=Math.ceil(Math.sqrt(t)),this._hullPrev=new Uint32Array(t),this._hullNext=new Uint32Array(t),this._hullTri=new Uint32Array(t),this._hullHash=new Int32Array(this._hashSize),this._ids=new Uint32Array(t),this._dists=new Float64Array(t),this.update()}update(){const{coords:e,_hullPrev:t,_hullNext:n,_hullTri:r,_hullHash:s}=this,a=e.length>>1;let o=1/0,l=1/0,c=-1/0,u=-1/0;for(let y=0;y<a;y++){const x=e[2*y],w=e[2*y+1];x<o&&(o=x),w<l&&(l=w),x>c&&(c=x),w>u&&(u=w),this._ids[y]=y}const h=(o+c)/2,f=(l+u)/2;let p,_,g;for(let y=0,x=1/0;y<a;y++){const w=Es(h,f,e[2*y],e[2*y+1]);w<x&&(p=y,x=w)}const m=e[2*p],d=e[2*p+1];for(let y=0,x=1/0;y<a;y++){if(y===p)continue;const w=Es(m,d,e[2*y],e[2*y+1]);w<x&&w>0&&(_=y,x=w)}let E=e[2*_],T=e[2*_+1],S=1/0;for(let y=0;y<a;y++){if(y===p||y===_)continue;const x=T_(m,d,E,T,e[2*y],e[2*y+1]);x<S&&(g=y,S=x)}let C=e[2*g],A=e[2*g+1];if(S===1/0){for(let w=0;w<a;w++)this._dists[w]=e[2*w]-e[0]||e[2*w+1]-e[1];pi(this._ids,this._dists,0,a-1);const y=new Uint32Array(a);let x=0;for(let w=0,O=-1/0;w<a;w++){const F=this._ids[w],W=this._dists[F];W>O&&(y[x++]=F,O=W)}this.hull=y.subarray(0,x),this.triangles=new Uint32Array(0),this.halfedges=new Uint32Array(0);return}if(Fi(m,d,E,T,C,A)<0){const y=_,x=E,w=T;_=g,E=C,T=A,g=y,C=x,A=w}const R=b_(m,d,E,T,C,A);this._cx=R.x,this._cy=R.y;for(let y=0;y<a;y++)this._dists[y]=Es(e[2*y],e[2*y+1],R.x,R.y);pi(this._ids,this._dists,0,a-1),this._hullStart=p;let D=3;n[p]=t[g]=_,n[_]=t[p]=g,n[g]=t[_]=p,r[p]=0,r[_]=1,r[g]=2,s.fill(-1),s[this._hashKey(m,d)]=p,s[this._hashKey(E,T)]=_,s[this._hashKey(C,A)]=g,this.trianglesLen=0,this._addTriangle(p,_,g,-1,-1,-1);for(let y=0,x,w;y<this._ids.length;y++){const O=this._ids[y],F=e[2*O],W=e[2*O+1];if(y>0&&Math.abs(F-x)<=hl&&Math.abs(W-w)<=hl||(x=F,w=W,O===p||O===_||O===g))continue;let X=0;for(let ce=0,ge=this._hashKey(F,W);ce<this._hashSize&&(X=s[(ge+ce)%this._hashSize],!(X!==-1&&X!==n[X]));ce++);X=t[X];let H=X,Y;for(;Y=n[H],Fi(F,W,e[2*H],e[2*H+1],e[2*Y],e[2*Y+1])>=0;)if(H=Y,H===X){H=-1;break}if(H===-1)continue;let V=this._addTriangle(H,O,n[H],-1,-1,r[H]);r[O]=this._legalize(V+2),r[H]=V,D++;let te=n[H];for(;Y=n[te],Fi(F,W,e[2*te],e[2*te+1],e[2*Y],e[2*Y+1])<0;)V=this._addTriangle(te,O,Y,r[O],-1,r[te]),r[O]=this._legalize(V+2),n[te]=te,D--,te=Y;if(H===X)for(;Y=t[H],Fi(F,W,e[2*Y],e[2*Y+1],e[2*H],e[2*H+1])<0;)V=this._addTriangle(Y,O,H,-1,r[H],r[Y]),this._legalize(V+2),r[Y]=V,n[H]=H,D--,H=Y;this._hullStart=t[O]=H,n[H]=t[te]=O,n[O]=te,s[this._hashKey(F,W)]=O,s[this._hashKey(e[2*H],e[2*H+1])]=H}this.hull=new Uint32Array(D);for(let y=0,x=this._hullStart;y<D;y++)this.hull[y]=x,x=n[x];this.triangles=this._triangles.subarray(0,this.trianglesLen),this.halfedges=this._halfedges.subarray(0,this.trianglesLen)}_hashKey(e,t){return Math.floor(S_(e-this._cx,t-this._cy)*this._hashSize)%this._hashSize}_legalize(e){const{_triangles:t,_halfedges:n,coords:r}=this;let s=0,a=0;for(;;){const o=n[e],l=e-e%3;if(a=l+(e+2)%3,o===-1){if(s===0)break;e=Mr[--s];continue}const c=o-o%3,u=l+(e+1)%3,h=c+(o+2)%3,f=t[a],p=t[e],_=t[u],g=t[h];if(E_(r[2*f],r[2*f+1],r[2*p],r[2*p+1],r[2*_],r[2*_+1],r[2*g],r[2*g+1])){t[e]=g,t[o]=f;const d=n[h];if(d===-1){let T=this._hullStart;do{if(this._hullTri[T]===h){this._hullTri[T]=e;break}T=this._hullPrev[T]}while(T!==this._hullStart)}this._link(e,d),this._link(o,n[a]),this._link(a,h);const E=c+(o+1)%3;s<Mr.length&&(Mr[s++]=E)}else{if(s===0)break;e=Mr[--s]}}return a}_link(e,t){this._halfedges[e]=t,t!==-1&&(this._halfedges[t]=e)}_addTriangle(e,t,n,r,s,a){const o=this.trianglesLen;return this._triangles[o]=e,this._triangles[o+1]=t,this._triangles[o+2]=n,this._link(o,r),this._link(o+1,s),this._link(o+2,a),this.trianglesLen+=3,o}}function S_(i,e){const t=i/(Math.abs(i)+Math.abs(e));return(e>0?3-t:1+t)/4}function Es(i,e,t,n){const r=i-t,s=e-n;return r*r+s*s}function E_(i,e,t,n,r,s,a,o){const l=i-a,c=e-o,u=t-a,h=n-o,f=r-a,p=s-o,_=l*l+c*c,g=u*u+h*h,m=f*f+p*p;return l*(h*m-g*p)-c*(u*m-g*f)+_*(u*p-h*f)<0}function T_(i,e,t,n,r,s){const a=t-i,o=n-e,l=r-i,c=s-e,u=a*a+o*o,h=l*l+c*c,f=.5/(a*c-o*l),p=(c*u-o*h)*f,_=(a*h-l*u)*f;return p*p+_*_}function b_(i,e,t,n,r,s){const a=t-i,o=n-e,l=r-i,c=s-e,u=a*a+o*o,h=l*l+c*c,f=.5/(a*c-o*l),p=i+(c*u-o*h)*f,_=e+(a*h-l*u)*f;return{x:p,y:_}}function pi(i,e,t,n){if(n-t<=20)for(let r=t+1;r<=n;r++){const s=i[r],a=e[s];let o=r-1;for(;o>=t&&e[i[o]]>a;)i[o+1]=i[o--];i[o+1]=s}else{const r=t+n>>1;let s=t+1,a=n;Ii(i,r,s),e[i[t]]>e[i[n]]&&Ii(i,t,n),e[i[s]]>e[i[n]]&&Ii(i,s,n),e[i[t]]>e[i[s]]&&Ii(i,t,s);const o=i[s],l=e[o];for(;;){do s++;while(e[i[s]]<l);do a--;while(e[i[a]]>l);if(a<s)break;Ii(i,s,a)}i[t+1]=i[a],i[a]=o,n-s+1>=a-t?(pi(i,e,s,n),pi(i,e,t,a-1)):(pi(i,e,t,a-1),pi(i,e,s,n))}}function Ii(i,e,t){const n=i[e];i[e]=i[t],i[t]=n}function w_(i){return i[0]}function A_(i){return i[1]}function cc(i,e,t){if(i!==null)for(var n,r,s,a,o,l,c,u=0,h=0,f,p=i.type,_=p==="FeatureCollection",g=p==="Feature",m=_?i.features.length:1,d=0;d<m;d++){c=_?i.features[d].geometry:g?i.geometry:i,f=c?c.type==="GeometryCollection":!1,o=f?c.geometries.length:1;for(var E=0;E<o;E++){var T=0,S=0;if(a=f?c.geometries[E]:c,a!==null){l=a.coordinates;var C=a.type;switch(u=0,C){case null:break;case"Point":if(e(l,h,d,T,S)===!1)return!1;h++,T++;break;case"LineString":case"MultiPoint":for(n=0;n<l.length;n++){if(e(l[n],h,d,T,S)===!1)return!1;h++,C==="MultiPoint"&&T++}C==="LineString"&&T++;break;case"Polygon":case"MultiLineString":for(n=0;n<l.length;n++){for(r=0;r<l[n].length-u;r++){if(e(l[n][r],h,d,T,S)===!1)return!1;h++}C==="MultiLineString"&&T++,C==="Polygon"&&S++}C==="Polygon"&&T++;break;case"MultiPolygon":for(n=0;n<l.length;n++){for(S=0,r=0;r<l[n].length;r++){for(s=0;s<l[n][r].length-u;s++){if(e(l[n][r][s],h,d,T,S)===!1)return!1;h++}S++}T++}break;case"GeometryCollection":for(n=0;n<a.geometries.length;n++)if(cc(a.geometries[n],e)===!1)return!1;break;default:throw new Error("Unknown Geometry Type")}}}}}function C_(i,e={}){if(i.bbox!=null&&e.recompute!==!0)return i.bbox;const t=[1/0,1/0,-1/0,-1/0];return cc(i,n=>{t[0]>n[0]&&(t[0]=n[0]),t[1]>n[1]&&(t[1]=n[1]),t[2]<n[0]&&(t[2]=n[0]),t[3]<n[1]&&(t[3]=n[1])}),t}class R_{constructor(e){Se(this,"center");Se(this,"up");Se(this,"right");Se(this,"forward");this.center=e,this.up=e.clone().normalize(),this.right=new L().crossVectors(this.up,new L(0,0,1)).normalize(),this.right.length()===0&&this.right.crossVectors(this.up,new L(0,1,0)).normalize(),this.forward=new L().crossVectors(this.up,this.right).normalize()}project3DTo2D(e){const t=e.clone().sub(this.center),n=t.dot(this.right),r=t.dot(this.forward);return new L(n,r,0)}project2DTo3D(e){const t=this.right.clone().multiplyScalar(e.x),n=this.forward.clone().multiplyScalar(e.y);return this.center.clone().add(t).add(n).normalize()}}function P_(i){const[e,t]=Va(i),n=(t+180)/360,r=(e+90)/180;return[n,r]}function Wa(i){const e=[];for(let n=0;n<i.length;n+=3){const r=new L(i[n],i[n+1],i[n+2]),s=P_(r);e.push(s[0],s[1])}const t=new fn;return t.setAttribute("position",new Ht(new Float32Array(i),3)),t.setAttribute("uv",new Ht(new Float32Array(e),2)),t.computeVertexNormals(),t}function ul(i,e,t){const n=[],r=[];for(let a=0;a<=t;a++)for(let o=0;o<=e;o++){const l=o/e,c=a/t,u=l*Math.PI*2,h=c*Math.PI,f=new L(-i*Math.cos(u)*Math.sin(h),i*Math.cos(h),i*Math.sin(u)*Math.sin(h));if(n.push(f.x,f.y,f.z),o<e&&a<t){const p=o+a*(e+1),_=o+(a+1)*(e+1);r.push(p,_,_+1),r.push(p,_+1,p+1)}}const s=Wa(n);return s.setIndex(r),s}function dl(i,e,t,n=100){const r=i.getLength(),s=Math.round(r*n),a=r/s,o=i.getPoints(s),l=[];let c,u;const h=.03,f=.05;for(let _=0;_<o.length-1;_++){const g=o[_],m=o[_+1],E=(o[_+2]||m).clone().sub(g).normalize(),T=m.clone().normalize(),S=new L().crossVectors(E,T).normalize(),C=c||g.clone().sub(S.clone().multiplyScalar(e)),A=u||g.clone().add(S.clone().multiplyScalar(e)),R=m.clone().sub(S.clone().multiplyScalar(e)),D=m.clone().add(S.clone().multiplyScalar(e));if(l.push(C.x,C.y,C.z,A.x,A.y,A.z,D.x,D.y,D.z,C.x,C.y,C.z,D.x,D.y,D.z,R.x,R.y,R.z),t&&_===o.length-2){const y=Math.floor(f/a)-2;l.splice(-18*y,18*y);const x=E.clone().multiplyScalar(f),w=m.clone().sub(x),O=S.clone().multiplyScalar(h),F=m,W=w.clone().sub(O),X=w.clone().add(O);l.push(W.x,W.y,W.z,X.x,X.y,X.z,F.x,F.y,F.z)}c=R,u=D}return{geometry:Wa(l),curvePoints:o}}function D_(i,e=.025){const t=Ll([i]),n=C_(t),[r,s,a,o]=n,l=i.slice();for(let h=s;h<=o;h+=e)for(let f=r;f<=a;f+=e)Us(Ls([f,h]),t)&&l.push([f,h]);const c=Ga.from(l),u=[];for(let h=0;h<c.triangles.length;h+=3){const[f,p,_]=[c.triangles[h],c.triangles[h+1],c.triangles[h+2]],[g,m,d]=[l[_],l[p],l[f]],E=Ls([(g[0]+m[0]+d[0])/3,(g[1]+m[1]+d[1])/3]);Us(E,t)&&u.push(_,p,f)}return{points:l,indices:u,box:n}}function hc(i){const e=i.map(([g,m])=>kn(g,m)),t=e.reduce((g,m)=>g.add(m),new L).divideScalar(e.length),n=new R_(t),r=e.map(g=>n.project3DTo2D(g)),s=new va(r,!0),a=s.getLength(),o=Math.round(a*200),l=s.getPoints(o),{points:c,indices:u,box:h}=D_(l.map(g=>[g.x,g.y])),f=c.map(g=>n.project2DTo3D(new L(g[0],g[1],0))),p=[];for(const g of u){const m=f[g];p.push(m.x,m.y,m.z)}return{geometry:Wa(p),averagePoint:t}}async function L_(i){const t=await(await fetch(i)).arrayBuffer();return new Float32Array(t)}async function Ts(i){const t=await(await fetch(i)).arrayBuffer();return new Uint8Array(t)}function fl(i,e,t,n){const r=new Fa(i,e,t,n);return r.magFilter=Rt,r.minFilter=Rt,r.wrapS=Gn,r.wrapT=Gn,r.needsUpdate=!0,r}async function U_(){const[i,e,t,n]=await Promise.all([Ts("climate.bin"),L_("sealevels.bin"),Ts("ice_outline.bin"),Ts("rivers.bin")]),r=[];for(let m=1;m<101;)r.push(m),m++;const s=97*48,a=49*48,o=s*2+a,l=new Uint8Array(s*4*r.length),c=new Uint8Array(a*4*r.length);for(let m=0;m<r.length;m++){const d=i.slice(m*o,m*o+s),E=i.slice(m*o+s,m*o+s*2),T=i.slice(m*o+s*2,m*o+o);for(let S=0;S<d.length;S++){const C=m*s*4+S*4;l[C]=d[S],l[C+1]=E[S],l[C+2]=255,l[C+3]=255}for(let S=0;S<T.length;S++){const C=T[S],A=m*a*4+S*4;c[A]=C,c[A+1]=C,c[A+2]=C,c[A+3]=255}}const u=fl(l,97,48,r.length),h=fl(c,49,48,r.length),f=new DataView(t.buffer),p=[];for(let m=0;m<t.length;){m+=4;const d=f.getUint16(m,!0);m+=2;const E=[];for(let T=0;T<d;T++){const S=f.getUint16(m,!0);if(m+=2,S===0)continue;const C=[];for(let R=0;R<S;R++){const D=f.getFloat32(m,!0);m+=4;const y=f.getFloat32(m,!0);m+=4,C.push([D,y])}const{geometry:A}=hc(C);E.push(A)}p.push(E)}const _=[],g=new DataView(n.buffer);for(let m=0;m<n.length;){const d=g.getUint16(m,!0);m+=2;const E=[];for(let T=0;T<d;T++){const S=g.getFloat32(m,!0);m+=4;const C=g.getFloat32(m,!0);m+=4,E.push([C,S])}_.push(E)}return{years:r,climateTextures:{temp:u,prec:h},sealevels:e,rivers:_,iceGeometries:p}}function pl(i,e){let t=0;for(let n=1;n<i.years.length;n++)if(e<=i.years[n]){const r=i.years[n-1];t=n-(1-(e-r)/(i.years[n]-r));break}return Math.min(i.years.length-1,t)}function I_(i,e){const t=e/2.5;return Math.max(0,Math.min(32,t))}function Sr(i,e){const t=Math.floor(e*10),n=Math.ceil(e*10),r=i.sealevels[Math.max(0,Math.min(i.sealevels.length-1,t))],s=i.sealevels[Math.max(0,Math.min(i.sealevels.length-1,n))];return-(r+(s-r)*(e*10-t))}const ml={type:"change"},Xa={type:"start"},uc={type:"end"},Er=new Oa,_l=new yn,N_=Math.cos(70*Xh.DEG2RAD),ut=new L,At=2*Math.PI,Ze={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},bs=1e-6;class F_ extends Du{constructor(e,t=null){super(e,t),this.state=Ze.NONE,this.enabled=!0,this.target=new L,this.cursor=new L,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:mi.ROTATE,MIDDLE:mi.DOLLY,RIGHT:mi.PAN},this.touches={ONE:di.ROTATE,TWO:di.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new L,this._lastQuaternion=new Yn,this._lastTargetPosition=new L,this._quat=new Yn().setFromUnitVectors(e.up,new L(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Bo,this._sphericalDelta=new Bo,this._scale=1,this._panOffset=new L,this._rotateStart=new Ae,this._rotateEnd=new Ae,this._rotateDelta=new Ae,this._panStart=new Ae,this._panEnd=new Ae,this._panDelta=new Ae,this._dollyStart=new Ae,this._dollyEnd=new Ae,this._dollyDelta=new Ae,this._dollyDirection=new L,this._mouse=new Ae,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=B_.bind(this),this._onPointerDown=O_.bind(this),this._onPointerUp=z_.bind(this),this._onContextMenu=Y_.bind(this),this._onMouseWheel=V_.bind(this),this._onKeyDown=G_.bind(this),this._onTouchStart=W_.bind(this),this._onTouchMove=X_.bind(this),this._onMouseDown=k_.bind(this),this._onMouseMove=H_.bind(this),this._interceptControlDown=q_.bind(this),this._interceptControlUp=j_.bind(this),this.domElement!==null&&this.connect(),this.update()}connect(){this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(ml),this.update(),this.state=Ze.NONE}update(e=null){const t=this.object.position;ut.copy(t).sub(this.target),ut.applyQuaternion(this._quat),this._spherical.setFromVector3(ut),this.autoRotate&&this.state===Ze.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=At:n>Math.PI&&(n-=At),r<-Math.PI?r+=At:r>Math.PI&&(r-=At),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=a!=this._spherical.radius}if(ut.setFromSpherical(this._spherical),ut.applyQuaternion(this._quatInverse),t.copy(this.target).add(ut),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=ut.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),s=!!l}else if(this.object.isOrthographicCamera){const o=new L(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=l!==this.object.zoom;const c=new L(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=ut.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(Er.origin.copy(this.object.position),Er.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Er.direction))<N_?this.object.lookAt(this.target):(_l.setFromNormalAndCoplanarPoint(this.object.up,this.target),Er.intersectPlane(_l,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>bs||8*(1-this._lastQuaternion.dot(this.object.quaternion))>bs||this._lastTargetPosition.distanceToSquared(this.target)>bs?(this.dispatchEvent(ml),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?At/60*this.autoRotateSpeed*e:At/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){ut.setFromMatrixColumn(t,0),ut.multiplyScalar(-e),this._panOffset.add(ut)}_panUp(e,t){this.screenSpacePanning===!0?ut.setFromMatrixColumn(t,1):(ut.setFromMatrixColumn(t,0),ut.crossVectors(this.object.up,ut)),ut.multiplyScalar(e),this._panOffset.add(ut)}_pan(e,t){const n=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;ut.copy(r).sub(this.target);let s=ut.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*s/n.clientHeight,this.object.matrix),this._panUp(2*t*s/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),r=e-n.left,s=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(s/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(At*this._rotateDelta.x/t.clientHeight),this._rotateUp(At*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(At*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-At*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(At*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-At*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,s=Math.sqrt(n*n+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),r=.5*(e.pageX+n.x),s=.5*(e.pageY+n.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(At*this._rotateDelta.x/t.clientHeight),this._rotateUp(At*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,s=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Ae,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function O_(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i)))}function B_(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function z_(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(uc),this.state=Ze.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function k_(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case mi.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=Ze.DOLLY;break;case mi.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Ze.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Ze.ROTATE}break;case mi.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=Ze.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=Ze.PAN}break;default:this.state=Ze.NONE}this.state!==Ze.NONE&&this.dispatchEvent(Xa)}function H_(i){switch(this.state){case Ze.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case Ze.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case Ze.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function V_(i){this.enabled===!1||this.enableZoom===!1||this.state!==Ze.NONE||(i.preventDefault(),this.dispatchEvent(Xa),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(uc))}function G_(i){this.enabled!==!1&&this._handleKeyDown(i)}function W_(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case di.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=Ze.TOUCH_ROTATE;break;case di.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=Ze.TOUCH_PAN;break;default:this.state=Ze.NONE}break;case 2:switch(this.touches.TWO){case di.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=Ze.TOUCH_DOLLY_PAN;break;case di.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=Ze.TOUCH_DOLLY_ROTATE;break;default:this.state=Ze.NONE}break;default:this.state=Ze.NONE}this.state!==Ze.NONE&&this.dispatchEvent(Xa)}function X_(i){switch(this._trackPointer(i),this.state){case Ze.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case Ze.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case Ze.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case Ze.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=Ze.NONE}}function Y_(i){this.enabled!==!1&&i.preventDefault()}function q_(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function j_(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const Ni=`uniform float projectionBlend;\r
\r
varying vec2 vUv;\r
...
}`,Z_=`uniform sampler2DArray tempTexture;\r
...
}`,K_=`uniform sampler2D heightTexture;\r
uniform float sealevel;\r
\r
varying vec2 vUv;\r
\r
...
}`,$_=`uniform sampler2D heightTexture;\r
uniform sampler2D lakeMaskTexture;\r
uniform float sealevel;\r
\r
...
\r
  gl_FragColor = vec4(outColor, 1.0);\r
}`,dc=document.getElementById("info");function eg(i,e){Aa(st(tg,{title:i,doc:e}),dc)}function tg({title:i,doc:e}){return st("div",{class:"max-w-[400px] text-white p-4 flex flex-col gap-2",children:[st("h1",{class:"text-3xl",children:i}),[...e.childNodes[0].childNodes].flatMap(t=>{if(t.nodeName==="text")return(t.textContent||"").split(`
`).map((n,r)=>st("p",{children:n},r));if(t.nodeName==="youtube"){const r=t.textContent.trim().match(/v=([^&]+)/)[1];return st("div",{class:"aspect-w-16 aspect-h-9 w-full relative flex justify-center",children:st("iframe",{class:"w-full h-full",src:`https://www.youtube-nocookie.com/embed/${r}`,allow:"fullscreen; encrypted-media; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin"})})}else if(t.nodeName==="wiki"){const n=t.textContent.trim();return st("div",{class:"",children:st("a",{class:"text-blue-500 underline",href:n,target:"_blank",children:decodeURI(n)})})}}),st("button",{class:"bg-gray-800 text-white p-2 rounded-md mt-8",onClick:()=>{Aa(null,dc)},children:"Close"})]})}const ws=1.003,gl=1.25,vl=5,xl=[new L(229/255,57/255,53/255),new L(216/255,27/255,96/255),new L(142/255,36/255,170/255),new L(94/255,53/255,177/255),new L(57/255,73/255,171/255),new L(0/255,172/255,193/255),new L(0/255,137/255,123/255),new L(255/255,179/255,0/255),new L(251/255,140/255,0/255),new L(244/255,81/255,30/255)];function fc(i){const e=i.split("").reduce((t,n)=>t+n.charCodeAt(0),0);return xl[e%xl.length]}function As(i){i.magFilter=Rt,i.minFilter=Rt,i.wrapS=Gn,i.wrapT=Gn,i.needsUpdate=!0}class ng{constructor(e,t,n,r){Se(this,"wrapper");Se(this,"overlay");Se(this,"year");Se(this,"onClick");Se(this,"renderer");Se(this,"scene");Se(this,"camera");Se(this,"controls");Se(this,"bounds");Se(this,"labels",[]);Se(this,"arrows",[]);Se(this,"areas",[]);Se(this,"earth");Se(this,"earthMaterial");Se(this,"riverMaterial");Se(this,"arrowMaterial");Se(this,"iceMaterial");Se(this,"climate");Se(this,"heightTexture");Se(this,"lakeMaskTexture");Se(this,"starsTexture");Se(this,"raycaster",new Pu);Se(this,"earthSphere",new zr(new L,1));Se(this,"cameraCoordinate");Se(this,"targetCoordinate");Se(this,"mouseDown");Se(this,"projectionBlend",0);Se(this,"iceMeshes",[]);Se(this,"existingIceMeshes",[]);this.wrapper=e,this.overlay=t,this.year=n,this.onClick=r,this.bounds=this.wrapper.getBoundingClientRect(),this.renderer=new m_({antialias:!0}),this.renderer.outputColorSpace=Ct,this.renderer.setSize(this.bounds.width,this.bounds.height),this.renderer.setPixelRatio(window.devicePixelRatio),this.wrapper.appendChild(this.renderer.domElement),window.addEventListener("resize",()=>{this.bounds=this.wrapper.getBoundingClientRect(),this.renderer.setSize(this.bounds.width,this.bounds.height),this.camera.aspect=this.bounds.width/this.bounds.height,this.camera.updateProjectionMatrix(),this.render()}),this.scene=new vu,this.camera=new kt(45,this.bounds.width/this.bounds.height,.01,1e3),this.cameraCoordinate=this.getLatLon(new Ae(0,0)),this.controls=new F_(this.camera,this.overlay),this.controls.enablePan=!1,this.controls.enableDamping=!1;const s=localStorage.getItem("camera");s?this.camera.position.copy(JSON.parse(s)):this.camera.position.set(0,0,3),this.controls.update();const a=ul(1,720,360);this.earthMaterial=new It({vertexShader:Ni,fragmentShader:Z_}),this.earth=new _t(a,this.earthMaterial),this.scene.add(this.earth),this.riverMaterial=new It({vertexShader:Ni,fragmentShader:K_}),this.arrowMaterial=new It({vertexShader:Ni,fragmentShader:J_,uniforms:{color:{value:new L(229/255,57/255,53/255)},transparency:{value:1},projectionBlend:{value:this.projectionBlend}},depthWrite:!0,depthTest:!1}),this.iceMaterial=new It({vertexShader:Ni,fragmentShader:Q_,uniforms:{projectionBlend:{value:this.projectionBlend}},depthWrite:!0,depthTest:!1}),this.initControls()}async load(){const e=new Au,t=await Promise.all([e.loadAsync("height.png"),e.loadAsync("lake-mask.png"),e.loadAsync("stars.jpg"),U_()]);this.heightTexture=t[0],this.lakeMaskTexture=t[1],this.starsTexture=t[2],this.climate=t[3],As(this.heightTexture),As(this.lakeMaskTexture),As(this.starsTexture),this.starsTexture.colorSpace=Ct,this.starsTexture.needsUpdate=!0;const n=new ki({map:this.starsTexture,side:2,depthTest:!1,depthWrite:!1}),r=new _t(ul(1,100,50),n);r.scale.setScalar(100),r.renderOrder=-1,this.scene.add(r),this.earthMaterial.uniforms={heightTexture:{value:this.heightTexture},lakeMaskTexture:{value:this.lakeMaskTexture},tempTexture:{value:this.climate.climateTextures.temp},precTexture:{value:this.climate.climateTextures.prec},sealevel:{value:Sr(this.climate,this.year)},climateYear:{value:pl(this.climate,this.year)},visualisation:{value:0},projectionBlend:{value:this.projectionBlend}},this.earthMaterial.needsUpdate=!0,this.riverMaterial.uniforms={heightTexture:{value:this.heightTexture},sealevel:{value:Sr(this.climate,this.year)},projectionBlend:{value:this.projectionBlend}},this.arrowMaterial.uniforms.heightTexture={value:this.heightTexture},this.iceMaterial.uniforms.heightTexture={value:this.heightTexture},this.initRivers(),this.iceMeshes=this.climate.iceGeometries.map(s=>s.map(a=>new _t(a,this.iceMaterial))),this.updateIce(),this.render()}initRivers(){for(const e of this.climate.rivers){const t=new va(e.map(([s,a])=>kn(s,a).multiplyScalar(ws))),{geometry:n}=dl(t,5e-4,!1,1e3),r=new _t(n,this.riverMaterial);this.scene.add(r)}}updateIce(){const e=Math.floor(I_(this.climate,this.year));for(const t of this.existingIceMeshes)this.scene.remove(t);this.existingIceMeshes=[];for(const t of this.iceMeshes[e])this.scene.add(t),this.existingIceMeshes.push(t)}onControlChange(){localStorage.setItem("camera",JSON.stringify(this.camera.position))}addLabel(e,t,n){const r="rgba(0, 0, 0, 0.5)",o=document.createElement("div");o.innerHTML=e.replace(/\n/g,"<br>"),o.style.position="absolute",o.style.textAlign="center",o.style.color="white",o.style.lineHeight="1.2",o.style.textShadow=`-${1.5}px -${1.5}px ${1.5}px ${r},${1.5}px -${1.5}px ${1.5}px ${r}, -${1.5}px ${1.5}px ${1.5}px ${r}, ${1.5}px ${1.5}px ${1.5}px ${r},-${1.5}px 0px ${1.5}px ${r},${1.5}px 0px ${1.5}px ${r},0px -${1.5}px ${1.5}px ${r},0px  ${1.5}px ${1.5}px ${r}`,o.style.transform="translate(-50%, -50%)",this.overlay.appendChild(o),n?(o.style.cursor="pointer",o.addEventListener("mousedown",c=>{eg(e,n),c.stopPropagation(),c.preventDefault()},!1)):(o.style.pointerEvents="none",o.style.userSelect="none",o.style.touchAction="none");const l={element:o,position:t,height:e.split(`
`).length*20};return this.labels.push(l),l}removeLabel(e){this.overlay.removeChild(e.element),this.labels.splice(this.labels.indexOf(e),1)}updateLabels(){const e=this.camera.position.clone().normalize(),t=[];for(const n of this.labels){const r=n.position.clone().normalize();if(e.dot(r)<0){t.push({x:0,y:0,label:n,show:!1});continue}const a=n.position.clone().project(this.camera);let o=(a.x+1)/2*this.bounds.width,l=(1-a.y)/2*this.bounds.height;t.push({x:o,y:l,label:n,show:!0})}for(let n=0;n<t.length;n++)if(t[n].show)for(let r=n+1;r<t.length;r++){if(!t[r].show)continue;const s=t[n],a=t[r],o=a.x-s.x;if(Math.abs(o)>100)continue;const l=a.y-s.y,c=(s.label.height+a.label.height)/2;if(l>=0&&l<c){const u=(c-l)/2;s.y-=u,a.y+=u}else if(l<=0&&l>-c){const u=(c+l)/2;s.y+=u,a.y-=u}}for(const{x:n,y:r,label:s,show:a}of t){if(a)s.element.style.display="block";else{s.element.style.display="none";continue}s.element.style.left=`${n}px`,s.element.style.top=`${r}px`}}render(){this.updateLabels(),this.renderer.render(this.scene,this.camera)}getLatLon(e){this.raycaster.setFromCamera(e,this.camera);const t=this.raycaster.ray.intersectSphere(this.earthSphere,new L);if(t){const n=Va(t);return new Ae(n[0],n[1])}}animate(){if(!this.targetCoordinate)return;const e=this.getLatLon(new Ae(0,0)),n=this.targetCoordinate.clone().sub(e).multiplyScalar(.1);this.cameraCoordinate=e.clone().add(n);const r=kn(this.cameraCoordinate.x,this.cameraCoordinate.y),s=this.camera.position.length();if(this.camera.position.copy(r).multiplyScalar(s),this.camera.lookAt(new L),this.render(),n.length()<.01){this.targetCoordinate=void 0;return}requestAnimationFrame(()=>this.animate())}getNormalisedMouse(e){const t=this.overlay.getBoundingClientRect(),n=new Ae;return n.x=(e.clientX-t.left)/t.width*2-1,n.y=-((e.clientY-t.top)/t.height)*2+1,n}initControls(){this.controls.addEventListener("change",()=>{const e=this.getLatLon(new Ae(0,0));this.cameraCoordinate=e,this.targetCoordinate=void 0;const t=this.camera.position.length();t<gl?this.camera.position.setLength(gl):t>vl&&this.camera.position.setLength(vl),this.controls.rotateSpeed=(this.camera.position.length()-1)/2,this.controls.zoomSpeed=(this.camera.position.length()-1)/2,this.onControlChange(),this.render()}),this.overlay.addEventListener("mousedown",e=>{this.mouseDown=this.getNormalisedMouse(e)}),this.overlay.addEventListener("mouseup",e=>{const t=this.getNormalisedMouse(e);if(this.mouseDown&&t.distanceTo(this.mouseDown)>.01){this.mouseDown=void 0;return}const n=this.getLatLon(t);n&&this.onClick([n.x,n.y],e.button)})}clean(){this.wrapper.removeChild(this.renderer.domElement),this.renderer.dispose()}setYear(e){this.year=e;const t=Sr(this.climate,e);this.earthMaterial.uniforms.climateYear.value=pl(this.climate,e+1),this.earthMaterial.uniforms.sealevel.value=t,this.riverMaterial.uniforms.sealevel.value=t;for(const n of this.areas)n.area.material.uniforms.sealevel.value=t;this.updateIce(),this.render()}setVisualisation(e){this.earthMaterial.uniforms.visualisation.value=e,this.render()}setTarget(e){this.targetCoordinate=new Ae(e[0],e[1]),this.animate()}setProjectionBlend(e){this.projectionBlend=e,this.earthMaterial.uniforms.projectionBlend.value=e,this.riverMaterial.uniforms.projectionBlend.value=e,this.arrowMaterial.uniforms.projectionBlend.value=e;for(const t of this.areas)t.area.material.uniforms.projectionBlend.value=e;this.render()}addMarker(e,t,n){const r=new _t(new Nr(.005,32,32),new ki({color:0}));r.position.copy(kn(e[0],e[1])),this.scene.add(r);const s=this.addLabel(t,r.position,n);return this.render(),{marker:r,label:s,remove:()=>{this.scene.remove(r),this.removeLabel(s),this.render()}}}addArrow(e,t,n){const r=new va(e.map(([u,h])=>kn(u,h).multiplyScalar(ws))),{geometry:s,curvePoints:a}=dl(r,.01,!0),o=new _t(s,this.arrowMaterial);o.renderOrder=999,this.scene.add(o);let l;if(t){const u=a[Math.floor(a.length/2)];l=this.addLabel(t,u,n)}this.render();const c={coordinates:e,arrow:o,label:l,remove:()=>{this.scene.remove(o),l&&this.removeLabel(l),this.render();const u=this.arrows.indexOf(c);u!==-1&&this.arrows.splice(u,1)}};return this.arrows.push(c),c}addArea(e,t,n,r){const{geometry:s,averagePoint:a}=hc(e),o=fc(t||"Area"),l=new It({vertexShader:Ni,fragmentShader:$_,uniforms:{color:{value:o},transparency:{value:.5},heightTexture:{value:this.heightTexture},lakeMaskTexture:{value:this.lakeMaskTexture},sealevel:{value:Sr(this.climate,this.year)},projectionBlend:{value:this.projectionBlend}},transparent:!0,depthWrite:!1,depthTest:!1}),c=new _t(s,l);c.renderOrder=999,this.scene.add(c);let u;t&&(u=this.addLabel(t,a,n));let h;r&&(h=e.map(([p,_],g)=>{const m=new _t(new Nr(.001,32,32),new ki({color:g===r.index?16777215:0,depthTest:!1}));return m.position.copy(kn(p,_).multiplyScalar(ws)),this.scene.add(m),m})),this.render();const f={coordinates:e,area:c,label:u,points:h,remove:()=>{this.scene.remove(c),u&&this.removeLabel(u),h&&h.forEach(_=>this.scene.remove(_)),this.render();const p=this.areas.indexOf(f);p!==-1&&this.areas.splice(p,1)}};return this.areas.push(f),f}}const ig=`Migration out\\nof Africa\r
-70000\r
Tool\r
arrow\r
5.09,35.88\r
...
</info>`;function lg(){const i=og.replace(/\r\n/g,`
`).split(`

`),e=[];for(const t of i){const n=t.split(`
`),r=n[0],s=n[1],[a,o]=s.split(","),{coordinates:l,info:c}=pc(n.slice(2),e),u={name:r,type:"location",period:[parseFloat(a),parseFloat(o)],coordinates:l[0],info:c};e.push(u)}return e}const cg=`Tool\r
Tool.svg\r
#FFEABB\r
\r
Farming\r
...
Sphinx\r
Sphinx.svg\r
#EDDCCF`;function hg(){return cg.replace(/\r\n/g,`
`).split(`

`).map(e=>{const t=e.split(`
`),[n,r,s]=t;return{name:n,url:r,color:s}})}function Cs(i){const e=[];for(const t of i.coordinates.flat())Array.isArray(t)?e.push(t):e.push(...t.coordinates);return lc(e)}function ug(i){return i.coordinates.map(e=>e.map(t=>Array.isArray(t)?t:lc(t.coordinates)))}async function dg(i,e,t){const n=hg(),r=lg(),s=ag(r,n),a=[...r,...s].sort((l,c)=>l.period[0]-c.period[0]);for(const l of s)e.addEvent(l);for(const l of r)e.addPeriod(l);function o(l){for(const c of a)if(c.period[0]>l||c.period[1]<l)c.removable&&(c.removable.remove(),delete c.removable);else{if(c.removable)continue;if(c.type==="location"){const u=c;u.coordinates.length===1?u.removable=i.addMarker(u.coordinates[0],u.name,u.info):u.removable=i.addArea(u.coordinates,u.name,u.info)}else if(c.type==="event"){const u=c;if(u.eventType==="arrow"){const h=ug(u).map((f,p)=>i.addArrow(f,p===0?u.name:"",p===0?u.info:void 0));u.removable={remove:()=>h.forEach(f=>f.remove())}}else u.eventType==="marker"&&(u.removable=i.addMarker(Cs(u),u.name,u.info))}}}return o(t),{setYear:l=>{o(l)},skipToPreviousEvent:()=>{const l=e.getYear(),c=s.slice().sort((u,h)=>h.time-u.time).find(u=>u.time<l);c&&(e.setTarget(c.time),i.setTarget(Cs(c)))},skipToNextEvent:()=>{const l=e.getYear(),c=s.slice().sort((u,h)=>u.time-h.time).find(u=>u.time>l);c&&(e.setTarget(c.time),i.setTarget(Cs(c)))}}}const fg=document.getElementById("earth-wrapper"),pg=document.getElementById("earth-overlay"),Ma=document.getElementById("earth"),mg=document.getElementById("timeline");function mc(){const i=fg.getBoundingClientRect();Ma.style.width=`${i.width}px`,Ma.style.height=`${i.height}px`}mc();window.addEventListener("resize",mc);async function _g(){const i=new sg(mg,r=>{e.setYear(Ml(r)),n.setYear(r)}),e=new ng(Ma,pg,Ml(i.getYear()),(r,s)=>{t.onClick(r,s)});await e.load();const t=new v_(e),n=await dg(e,i,i.getYear());y_(n,e,t)}_g().catch(console.error);
